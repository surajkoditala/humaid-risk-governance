...
resource "azurerm_monitor_diagnostic_setting" "storage_account" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-st-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
...
resource "azurerm_monitor_diagnostic_setting" "blob" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-stblob-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
