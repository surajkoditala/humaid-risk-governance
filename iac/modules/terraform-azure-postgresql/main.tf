...
resource "azurerm_management_lock" "this" {
  ...
  name       = coalesce(var.lock.name, "lock-pgsql-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}")
...
resource "azurerm_role_assignment" "this" {
  ...
  scope                                  = each.value.scope != null ? each.value.scope : azurerm_postgresql_flexible_server.this.id
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-pgsql-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
...
resource "azurerm_postgresql_flexible_server" "this" {
  ...
  name                              = var.name != null ? var.name : "pgsql-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
...
#Administrator user accounts (AD Admin)
