...
resource "azurerm_private_endpoint" "this_managed_dns_zone_groups" {
  ...
  name                          = each.value.name != null ? each.value.name : "pep-pgsql-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
  ...
  private_service_connection {
    ...
    name                           = each.value.private_service_connection_name != null ? each.value.private_service_connection_name : "pse-pgsql-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
