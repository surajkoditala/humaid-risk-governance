...
resource "azurerm_management_lock" "this" {
  ...
  name       = coalesce(var.lock.name, "lock-cr-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}")
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-cr-${var.tags.product}-${var.tags.environment}-${local.user_preferred_index}"
...
resource "azurerm_container_registry" "this" {
  ...
  name                          = var.name != null ? var.name : "cr${var.tags.product}${var.tags.environment}${local.user_preferred_index}"
