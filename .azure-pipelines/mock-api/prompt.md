...
- The service is deliberately NOT part of the Workbench: no ProjectReference to any 1-API..5-Presentation project, no shared DB connection/DbContext. It owns its own `mock_systems` schema and connection string.
